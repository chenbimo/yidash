 ...
 */
export default function openWindow(url, title, width, height) {
    // 获取屏幕位置和尺寸
    const dualScreenLeft = window.screenLeft ?? window.screenX ?? screen.left;
    const dualScreenTop = window.screenTop ?? window.screenY ?? screen.top;
