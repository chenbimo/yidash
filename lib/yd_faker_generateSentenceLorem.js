import { yd_faker_generateWordLorem } from './yd_faker_generateWordLorem.js';
 ...
 */
export function yd_faker_generateSentenceLorem (wordCount = 10) {
    const sentence = [];
    for (let i = 0; i < wordCount; i++) {
        sentence.push(yd_faker_generateWordLorem());
    }
    // 将单词拼接成句子，并在句尾添加句号
